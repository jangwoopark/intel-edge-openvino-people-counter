#This notebook was created to get the measurements for comparing #the pre and post models of OpenVino.
...
graph_file_ssd = 'ssd_inception_v2_coco_2018_01_28/frozen_inference_graph.pb'
graph_file_faster_rcnn = 'faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb'

input_file_video = 'resources/Pedestrian_Detect_2_1_1.mp4'
input_file_image = 'images/people-counter-image.png'


def main():
    model = load_model(graph_file_faster_rcnn)
    session = init_session(model)
    convert_image(session, input_file_image, "image-out.png")
    convert_video(session, input_file_video, "video-out-faster-rcnn.mp4")
